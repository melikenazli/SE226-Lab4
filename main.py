...
set2 = set()
for z in range(5):
    user_number = int (input("Enter a number in the range 3 to 7: "))
    while user_number<3 or user_number>7:
        user_number = int (input("Your number is not in the range!Please enter a number in the range: "))
    ...
    if user_number<5:
        set1.add(user_password)
    else:
        set2.add(user_password)
...
sorted_dictionary = sorted(merged_dictionary_items)
print(sorted_dictionary)
ascending_values = sorted(merged_dictionary.values(), reverse= True)
descending_values = sorted(merged_dictionary.values())
print("Maximum value: ", ascending_values[0])
print("Minimum value: ",descending_values[0])